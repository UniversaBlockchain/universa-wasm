...
describe('Hash', function() {
  ...
  describe('SHA', function() {
    describe('SHA256', function() {
      ...
      beforeEach(async function() { sha256 = new SHA('256'); });
      ...
      it('should calculate hash for message "one" (static)', async () => {
        var msg = 'one';

        const digest = await SHA.getDigest('sha256', textToBytes(msg));
    ...
    describe('SHA512', function() {
      ...
      beforeEach(async function() { sha512 = new SHA('512'); });
